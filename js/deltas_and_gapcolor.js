function deltas_and_gapcolor() {
    if (donnees.d != undefined && selected_idxjs >= 0) {
        ...
        for (var i in donnees.d) {
            ...
            if (disp_["delta"] == 1 || disp_gapcolors) {
                ...
                if (selected_idxjs in donnees.d) {
                    ...
                    if ((donnees.pro_v == 1 || donnees.try_v == 1) && (donnees.d[selected_idxjs].classid == donnees.d[i].classid || deltagraph_for_all == 1 || disp_gapcolors)) {
                        ...
                        if ((deltax[i] != deltaxold[i])) {     // on ralentit l'actualisation du delta
                            ...
                            if (rel2[i] * rel2old[0][i] < 0 && Math.abs(rel2[i]) > 1) { // Si on a changé de signe c'est que ds posf3 est passé devant ou derrière donc on réinit. le delta
                                if (donnees.d[selected_idxjs].classid == donnees.d[i].classid || deltagraph_for_all == 1) {
                                    if (disp_["delta"] == 1) {
            ...
            if (tmp_rel_i_col != "") set_style_color('rel' + i, tmp_rel_i_col);
            if (tmp_gap_i_col != "") set_style_color('gap' + i, tmp_gap_i_col);
