...
function opt_borders(elt) {
    if(broadcast == 0 && ws != null) {
        if (elt.checked) {
            window_borders = 1;
            ws.send("window;" + window_name + ";-1;-1;-1;-1;-1;" + window_topmost + ";1;-1");
        } else {
            window_borders = 0;
            ws.send("window;" + window_name + ";-1;-1;-1;-1;-1;" + window_topmost + ";0;-1");
        }
    }
}
...
function opt_transparency() {
    ...
    if(broadcast == 0 && ws != null) {
        ws.send("window;"+window_name+";-1;-1;-1;-1;"+window_alpha+";"+window_topmost+";-1;-1");
    }
}
...
function opt_always_on_top(elt) {
    if(broadcast == 0 && ws != null) {
        if (elt.checked) {
            window_topmost = 1;
            ws.send("window;" + window_name + ";-1;-1;-1;-1;-1;1;-1;-1");
        } else {
            window_topmost = 0;
            ws.send("window;" + window_name + ";-1;-1;-1;-1;-1;0;-1;-1");
        }
    }
}
...
function opt_window_x() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;"+window_name+";"+window_x+";-1;-1;-1;-1;"+window_topmost+";-1;-1");
    }
}
...
function opt_window_y() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;"+window_name+";-1;"+window_y+";-1;-1;-1;"+window_topmost+";-1;-1");
    }
}
...
function opt_window_w() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;"+window_name+";-1;-1;"+window_w+";-1;-1;"+window_topmost+";-1;-1");
    }
}
...
function opt_window_h() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;"+window_name+";-1;-1;-1;"+window_h+";-1;"+window_topmost+";-1;-1");
    }
}
...
function opt_iracing_fullscreen() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;iRacing.com Simulator;0;0;0;0;-1;"+window_iracing_topmost+";0;-1");
    }
}
...
function opt_iracing_1280x720() {
    if(broadcast == 0 && ws != null) {
        ws.send("window;iRacing.com Simulator;" + window_iracing_x + ";" + window_iracing_y + ";1280;720;-1;"+window_iracing_topmost+";-1;-1");
    }
}
...
function opt_iracing_1920x1080() {
    if(broadcast == 0 && ws != null) {
        ws.send("window;iRacing.com Simulator;" + window_iracing_x + ";" + window_iracing_y + ";1920;1080;-1;"+window_iracing_topmost+";-1;-1");
    }
}
...
function opt_iracing_borders(elt) {
    if(broadcast == 0 && ws != null) {
        if (elt.checked) {
            ...
            ws.send("window;iRacing.com Simulator;-1;-1;-1;-1;-1;" + window_iracing_topmost + ";1;-1");
        } else {
            window_iracing_borders = 0;
            ws.send("window;iRacing.com Simulator;-1;-1;-1;-1;-1;" + window_iracing_topmost + ";0;-1");
        }
    }
}
...
function opt_iracing_always_on_top(elt) {
    if(broadcast == 0 && ws != null) {
        if (elt.checked) {
            ...
            ws.send("window;iRacing.com Simulator;-1;-1;-1;-1;-1;1;-1;-1");
        } else {
            window_iracing_topmost = 0;
            ws.send("window;iRacing.com Simulator;-1;-1;-1;-1;-1;0;-1;-1");
        }
    }
}
...
function opt_iracing_window_x() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;iRacing.com Simulator;"+window_iracing_x+";-1;-1;-1;-1;"+window_iracing_topmost+";-1;-1");
    }
}
...
function opt_iracing_window_y() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;iRacing.com Simulator;-1;"+window_iracing_y+";-1;-1;-1;"+window_iracing_topmost+";-1;-1");
    }
}
...
function opt_iracing_window_w() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;iRacing.com Simulator;-1;-1;"+window_iracing_w+";-1;-1;"+window_iracing_topmost+";-1;-1");
    }
}
...
function opt_iracing_window_h() {
    if(broadcast == 0 && ws != null) {
        ...
        ws.send("window;iRacing.com Simulator;-1;-1;-1;"+window_iracing_h+";-1;"+window_iracing_topmost+";-1;-1");
    }
}
...
function opt_iracing_photo() {
    if (broadcast == 0 && ws != null) {
        ...
        if (photo_processing == 0 && free_ram != undefined) {
            ...
            photo_preview_w = document.getElementById('opt_iracing_photo_preview_w').value;
            photo_preview_h = document.getElementById('opt_iracing_photo_preview_h').value;
            photo_rewind_seconds = document.getElementById('opt_iracing_photo_rewind_seconds').value;
            ws.send("photo;" + shutter + ";" + window_iracing_borders + ";" + photo_w + ";" + photo_h + ";" + photo_smooth + ";" + photo_bracketting + ";" + photo_cuda_level + ";" + photo_display + ";" + photo_AA2 + ";" + photo_check + ";" + nb_images_div + ";" + fix_4K + ";" + fix_4K_coef + ";" + photo_x0 + ";" + photo_y0 + ";" + photo_spotter_pack + ";" + photo_hide_watermark + ";" + photo_preview_manual_reso + ";" + photo_preview_w + ";" + photo_preview_h + ";" + photo_rewind_seconds);
...
function opt_iracing_photo_preview_w() {
    if (broadcast == 0) {
        photo_preview_w = document.getElementById('opt_iracing_photo_preview_w').value;
    }
}

function opt_iracing_photo_preview_h() {
    if (broadcast == 0) {
        photo_preview_h = document.getElementById('opt_iracing_photo_preview_h').value;
    }
}

function opt_iracing_photo_rewind_seconds() {
    if (broadcast == 0) {
        photo_rewind_seconds = document.getElementById('opt_iracing_photo_rewind_seconds').value;
    }
}
...
function opt_iracing_photo_preview_manual_reso(elt) {
    if (broadcast == 0) {
        if (elt.checked) {
            photo_preview_manual_reso = 1;
        } else {
...
function opt_charge_photo_favoris(option) {
    ...
    if (photo_preview_manual_reso) {
        document.getElementById('opt_iracing_photo_preview_manual_reso').checked = true
    } else {
        document.getElementById('opt_iracing_photo_preview_manual_reso').checked = false
    }
    document.getElementById('opt_iracing_photo_preview_w').value = photo_preview_w;
    document.getElementById('opt_iracing_photo_preview_h').value = photo_preview_h;
    document.getElementById('opt_iracing_photo_rewind_seconds').value = photo_rewind_seconds;
...
function opt_save_photo_favoris() {
    if (ws != null) {
        ws.send("save_photo_favoris;" + shutter + ";" + photo_w + ";" + photo_h + ";" + photo_smooth + ";" + photo_bracketting + ";" + photo_cuda_level + ";" + photo_display + ";" + photo_AA2 + ";" + photo_check + ";" + fix_4K + ";" + fix_4K_coef + ";" + photo_x0 + ";" + photo_y0 + ";" + photo_hide_watermark + ";" + photo_preview_manual_reso + ";" + photo_preview_w + ";" + photo_preview_h + ";" + photo_rewind_seconds);
    }
}
