        ...
        for (i in donnees.d) {
            ...
            if ((donnees.d[i].fr == 0) && (donnees.d[i].pr == 1 || donnees.d[i].s > 1 || donnees.d[i].cts != -1)) {
                ...
                if (donnees.d[i].cts != -1 || donnees.d[i].pr != 1) {  // si un pilote est aux pits et a quitté le jeu on ne l'affiche pas
                    ...
                    if (donnees.d[i].s < 40 && !(donnees.d[i].pr)) {  // Les pilotes quasiments arrêtés sur les piste on les met en jaune
                        coul = "rgb(255,255,0)";
...
function draw_track(coul, opac, epaisseur, efface) {
        ...
        if (trackmap_disp_logo == 1) {
            ...
            $(img)
                .load(function () {
                    ...
                    $("#trackmap_3d_logo").css("background-image", "url('" + imgurl + "?" + Math.random() + "')");
                })
                .error(function () {
                    imgurl = "url('./img - default/trackmap_logo.png')";
                    $("#trackmap_3d_logo").css("background-image", "url('" + imgurl + "?" + Math.random() + "')");
        ...
        if (trackmap_bg_img) {
            ...
            $(img2)
                .load(function () {
                    ...
                    $("#trackmap_3d_bg").css("background-image", "url('" + imgurl + "?" + Math.random() + "')");
                })
                .error(function () {
                    imgurl = "url('./img - default/trackmap_bg.png')";
                    $("#trackmap_3d_bg").css("background-image", "url('" + imgurl + "?" + Math.random() + "')");
    ...
    if (trackmap_disp_logo == 0) {
        $("#trackmap_3d_logo").css("background-image", "url('./img - default/trackmap_nologo.png" + "?" + Math.random() + "')");
    }
