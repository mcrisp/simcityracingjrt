...
function boucle_delta(i) {
    ...
    if (deltax[i] != deltaxold[i]) {     // on ralentit l'actualisation du delta
        ...
        if (rel2start[i] < 999999) {
            ...
            if (i == 1) {
                if (advanced["perso_font_color_" + "pre_rel" + disp_sel]) {
                    set_style_color('pre_rel', advanced["font_color_" + "pre_rel" + disp_sel]);
                } else {
                    set_style_color('pre_rel', couleurs2[coul]);
                }
            } else {
                if (advanced["perso_font_color_" + "post_rel" + disp_sel]) {
                    set_style_color('post_rel', advanced["font_color_" + "post_rel" + disp_sel]);
                } else {
